...
A **280 × 280 px** static widget for GitHub Pages (iframe size `280` × `280`): Hong Kong time, date, and today’s **7-day cycle**. No full-screen background—only the card.
...
Then visit `http://localhost:8080/?date=2026-08-26` (Holiday) or `?date=2026-09-01` (Special Day) or `?date=2026-09-07` (Day 1). Embed with `<iframe src="..." width="280" height="280">`.
